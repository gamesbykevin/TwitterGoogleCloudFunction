...
var ignoreUserIdsPerDocument = 30000;

//how many users can we follow each time this app runs
const followLimit = 5;

//how many users can we unfollow each time this app runs
const unfollowLimit = 5;

//our twitter credentials
const consumer_key 		  = 'consumer key from https://developer.twitter.com/en/apps';
const consumer_secret 	  = 'consumer secret from https://developer.twitter.com/en/apps';
const access_token 		  = 'access token from https://developer.twitter.com/en/apps';
const access_token_secret = 'access token secret from https://developer.twitter.com/en/apps';

//our twitter account name
const username = 'gamesbykevin';
